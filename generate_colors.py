...
kotlin_file = """package com.comfort.app.theme
...
with open("C:/Users/domin/Desktop/gallerydl/app/src/main/java/com/comfort/app/theme/Color.kt", "w") as f:
    f.write(kotlin_file)

print("Generated Color.kt")
